...
FUN_NEWS_RESEARCHER: SubAgent = {
    ...
    "system_prompt": (
        ...
        "- TOPIC DIVERSITY IS ESSENTIAL. Span at least FOUR different topic areas — "
        "e.g. sport, science & space, arts/music/film, human kindness & community, "
        "quirky records & oddities, food & drink, medical breakthroughs, tech-for-good, "
        "travel, sport. AT MOST ONE animal/wildlife/nature story in the whole set. "
        "Tag each candidate with a 'category'.\n"
        ...
        "newsroom HOLDS the edition rather than print fabricated content. Collect "
        "~12-15 strong candidates with "
        "{title, summary, source_url, continent, category}, covering a SPREAD of "
        "categories (not mostly animals), then write them to the file "
        "research/fun_candidates.json. The harness will dedupe, re-validate, and pick "
        "the final 5 deterministically — your job is breadth (topics AND continents) "
        "and good judgement on tone, not the final cut."
    ),
