...
def get_educational_model_configs() -> Dict[str, ModelConfig]:
    ...
    configs["imagen-3.0-generate-002"] = ModelConfig(
        ...
        api_endpoint="https://aiplatform.googleapis.com/v1/projects/{project}/locations/us-central1/publishers/google/models/imagen-3:predict",
        requires_api_key=True,
        api_key_env_var="GOOGLE_API_KEY",
        gemini_project_id="required",
        requests_per_minute=10,  # Conservative for image generation
        educational_notes={
            "use_case": "High-quality image generation",
            "best_for": "Photorealistic images, artistic content",
            "api_pattern": "Google Cloud AI Platform API",
            "prompt_format": "Text description with style parameters",
            "special_features": "Advanced photorealism, style control",
            "note": "Requires Google Cloud project setup",
            "availability": "Limited beta - may not be publicly available"
        }
    )
